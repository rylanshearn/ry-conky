...
--
--  This is a modification of seamod_rings.lua, lunatico_rings.lua and conky_orange.lua 
--
--  conky_seamod.lua:    http://seajey.deviantart.com/art/Conky-Seamod-v0-1-283461046
...
gauge_neg = {
{
    ...
    hand_fg_colour=0x778dff,       hand_fg_alpha=1.0,
    txt_radius=132,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0x778dff,        txt_fg_alpha=1.0,
...
-- displays gauges
--
function draw_gauge_ring_neg(display, data, value)
...
--
function go_gauge_rings_neg(display)
    local function load_gauge_rings_neg(display, data)
        local str, value = '', 0
        str = string.format('${%s %s}',data['name'], data['arg'])
        str = conky_parse(str)
        value = tonumber(str)
        draw_gauge_ring_neg(display, data, value)
    end
    
    for i in pairs(gauge_neg) do
        load_gauge_rings_neg(display, gauge_neg[i])
    end
end
